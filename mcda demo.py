...
Система автоматично застосовує *внутрішньодоменне поглинання* (захист від дублювання діагнозів) та *асимптотичне додавання*, для врахування декількох кодів МКФ для оцінки загального стану пацієнта, це первинний нарис логіки, який необхідно буде калібрувати на наявних даних попередніх ВЛК та потреб МОУ.
""")
